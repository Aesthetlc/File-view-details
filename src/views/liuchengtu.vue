<template>
  <div id="sample">
    <div style="width: 100%; display: flex; justify-content: space-between">
      ...
      <div id="this.myDiagramDiv" style="flex-grow: 1; height: 750px; background-color: #282c34;"></div>
    </div>

    <el-button type="primary" plain id="SaveButton" @click="save()">保存</el-button>
    <el-button type="info" plain @click="load()">重新加载</el-button>
    <el-button type="warning" plain @click="printDiagram()">保存流程图</el-button>
...
export default {
  ...
  methods: {
    init() {
      ...
      this.myDiagram = $(
        go.Diagram,
        'this.myDiagramDiv', // must name or refer to the DIV HTML element
        {
      ...
      this.myDiagram.linkTemplate = $(
        go.Link, // the whole link panel
        {
          ...
          mouseEnter: function(e, link) {
            link.findObject('HIGHLIGHT').stroke = 'rconsole.log()gba(30,144,255,0.2)'
          },
